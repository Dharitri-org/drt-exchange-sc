...
pub struct ClaimRewardsEvent<M: ManagedTypeApi> {
    old_farm_token: DctTokenPayment<M>,
    new_farm_token: DctTokenPayment<M>,
    farm_supply: BigUint<M>,
    reward_tokens: DctTokenPayment<M>,
    reward_reserve: BigUint<M>,
...
pub trait EventsModule {
    ...
    >(
        ...
        input_farming_token: DctTokenPayment<Self::Api>,
    ...
    >(
        ...
        output_farming_tokens: DctTokenPayment<Self::Api>,
        output_reward: DctTokenPayment<Self::Api>,
        storage_cache: StorageCache<'a, C>,
    ) {
        let epoch = self.blockchain().get_block_epoch();
        let block = self.blockchain().get_block_nonce();
    ...
    >(
        ...
        let reward_tokens = DctTokenPayment::new(
