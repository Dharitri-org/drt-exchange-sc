...
use crate::claim_rewards_context::dharitri_codec::TopEncode;
    ...
    T: Clone + TopEncode + TopDecode + NestedEncode + NestedDecode,
{
    ...
    pub additional_payments: ManagedVec<M, DctTokenPayment<M>>,
}
...
{
    pub fn new(
        mut payments: ManagedVec<M, DctTokenPayment<M>>,
        ...
        let token_data = api_wrapper.get_dct_token_data(
            &own_sc_address,
            farm_token_id,
