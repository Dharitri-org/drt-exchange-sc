    ...
    T: Clone + TopEncode + TopDecode + NestedEncode + NestedDecode,
{
    ...
    pub rewards: DctTokenPayment<C::Api>,
    ...
    + utils::UtilsModule
{
    fn claim_rewards_base<FC: FarmContract<FarmSc = Self>>(
        ...
        let minted_farm_token_nonce = self.send().dct_nft_create_compact(
    ...
    fn claim_rewards_base_no_farm_token_mint<FC: FarmContract<FarmSc = Self>>(
        ...
        self.burn_multi_dct(&claim_rewards_context.additional_payments);
        ...
        InternalClaimRewardsResult {
            ...
            rewards: DctTokenPayment::new(storage_cache.reward_token_id.clone(), 0, reward),
            new_farm_token,
            storage_cache,
        }
    }
