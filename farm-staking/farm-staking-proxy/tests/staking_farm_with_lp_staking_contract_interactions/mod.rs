    ...
    ProxyContractObjBuilder: 'static + Copy + Fn() -> farm_staking_proxy::ContractObj<DebugApi>,
{
    ...
    pub fn stake_farm_lp_proxy_multiple(
        ...
        self.b_mock
            .execute_dct_multi_transfer(&self.user_addr, &self.proxy_wrapper, &transfers, |sc| {
        ...
        self.b_mock
            .execute_dct_transfer(
                ...
                |sc| {
                    ...
                    if expected_wmoax_amount > 0 {
                        let wmoax_payment = received_tokens.get(vec_index);
                        assert_eq!(wmoax_payment.amount, expected_wmoax_amount);
