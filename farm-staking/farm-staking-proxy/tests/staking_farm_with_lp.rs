    ...
    setup
        ...
        .execute_dct_transfer(
            ...
            |sc| {
                ...
                let wmoax_payment = results.other_token_payment;
                assert_eq!(
                    wmoax_payment.token_identifier,
                    managed_token_id!(WMOAX_TOKEN_ID)
                );
                assert_eq!(wmoax_payment.amount, dual_yield_token_amount / 2);
    ...
    setup
        ...
        .execute_dct_transfer(
            ...
            |sc| {
                ...
                assert_eq!(wmoax_payment.amount, 1_001_000_000 / 2);
...
fn test_farm_stake_proxy_merging_boosted_rewards() {
    ...
    setup
        .b_mock
        .set_dct_balance(&temp_user, LP_TOKEN_ID, &rust_biguint!(1));
