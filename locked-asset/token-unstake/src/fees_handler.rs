    ...
    + events::EventsModule
{
    ...
    fn burn_penalty(&self, payment: DctTokenPayment) {
        ...
        self.send()
            .dct_local_burn(&payment.token_identifier, payment.token_nonce, &burn_amount);

        self.send_fees_to_collector(DctTokenPayment::new(
    ...
    fn send_fees_to_collector(&self, payment: DctTokenPayment) {
