    ...
    + dharitri_sc_modules::default_issue_callbacks::DefaultIssueCallbacksModule
{
    ...
    fn add_lp_to_whitelist(
        ...
        require!(
            first_token_id.is_valid_dct_identifier() && second_token_id.is_valid_dct_identifier(),
            "Only DCT tokens accepted"
        );
        require!(
    ...
    fn unlock_single_payment(
        ...
        if payment.token_identifier == locked_token_id {
            ...
            let unlocked_payment = DctTokenPayment::new(
                attributes.original_token_id.unwrap_dct(),
