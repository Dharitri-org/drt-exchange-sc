...
pub type EnterFarmThroughProxyResultType<M> = MultiValue2<DctTokenPayment<M>, DctTokenPayment<M>>;
pub type ExitFarmThroughProxyResultType<M> = MultiValue2<DctTokenPayment<M>, DctTokenPayment<M>>;
    ...
    + dharitri_sc_modules::default_issue_callbacks::DefaultIssueCallbacksModule
{
    ...
    /// `1` - FarmWithLockedRewards - rewards are META DCT locked tokens
    #[only_owner]
    ...
    fn enter_farm_locked_token(
        ...
        for p in &additional_proxy_farm_tokens {
            ...
            additional_farm_payments.push(DctTokenPayment::new(
