...
pub struct LockReduceResult<M: ManagedTypeApi> {
    ...
    pub unlocked_tokens: MoaxOrDctTokenPayment<M>,
    pub energy: Energy<M>,
}
    ...
    + crate::token_whitelist::TokenWhitelistModule
{
    ...
    fn unlock_early(&self) {
        ...
        let unlocked_tokens = self.to_dct_payment(reduce_result.unlocked_tokens);
    ...
    fn reduce_lock_period(&self, new_lock_period: Epoch) -> DctTokenPayment {
        ...
        self.to_dct_payment(new_locked_tokens)
    }
