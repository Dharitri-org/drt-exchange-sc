    ...
    + pausable::PausableModule
{
    ...
    fn update_and_get_tokens_for_given_position_with_safe_price(
        ...
        MultiValue2::from((
            DctTokenPayment::new(first_token_id, 0, first_token_worth),
            DctTokenPayment::new(second_token_id, 0, second_token_worth),
        ))
    }
    ...
    fn update_and_get_safe_price(
        ...
        DctTokenPayment::new(t_out, 0, self.quote(&input.amount, &r_in, &r_out))
    }
