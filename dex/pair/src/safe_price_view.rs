    ...
    + pausable::PausableModule
{
    ...
    fn get_lp_tokens_safe_price(
        ...
        if lp_total_supply == 0 {
            return (
                DctTokenPayment::new(first_token_id, 0, BigUint::zero()),
                DctTokenPayment::new(second_token_id, 0, BigUint::zero()),
            )
                .into();
        }
        ...
        let first_token_payment = DctTokenPayment::new(first_token_id, 0, first_token_worth);
        let second_token_payment = DctTokenPayment::new(second_token_id, 0, second_token_worth);
    ...
    fn compute_weighted_price(
        ...
        if input_payment.token_identifier == first_token_id {
            ...
            DctTokenPayment::new(second_token_id, 0, output_amount)
            ...
            DctTokenPayment::new(first_token_id, 0, output_amount)
        } else {
