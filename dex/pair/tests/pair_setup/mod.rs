    ...
    PairObjBuilder: 'static + Copy + Fn() -> pair::ContractObj<DebugApi>,
{
    ...
    pub fn add_liquidity(
        ...
        self.b_mock
            .execute_dct_multi_transfer(&self.user_address, &self.pair_wrapper, &payments, |sc| {
    ...
    pub fn swap_fixed_output(
        ...
        let initial_payment_token_balance =
            self.b_mock
                .get_dct_balance(&self.user_address, payment_token_id, 0);
        let initial_desired_token_balance =
            self.b_mock
                .get_dct_balance(&self.user_address, desired_token_id, 0);
