    ...
    FarmObjBuilder: 'static + Copy + Fn() -> farm::ContractObj<DebugApi>,
{
    ...
    pub fn enter_farm(
        ...
        b_mock
            .execute_dct_multi_transfer(&self.user_address, &self.farm_wrapper, &payments, |sc| {
    ...
    pub fn exit_farm(
        ...
        b_mock.check_dct_balance(&self.user_address, MEX_TOKEN_ID, expected_user_mex_balance);
