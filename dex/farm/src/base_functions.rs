...
pub type DoubleMultiPayment<M> = MultiValue2<DctTokenPayment<M>, DctTokenPayment<M>>;
    ...
    + energy_query::EnergyQueryModule
{
    ...
    fn merge_farm_tokens<FC: FarmContract<FarmSc = Self>>(&self) -> DctTokenPayment<Self::Api> {
