WALLET_PEM="/home/dharitri/dharitrisdk/moapy-venv/lib/python3.8/site-packages/moapy/testnet/wallets/users/mike.pem"
...
redeem() {
    moapy --verbose contract call ${SELF_ADDR} --recall-nonce \
        --pem=${WALLET_PEM} \
        --gas-limit=60000000 \
        --proxy=${PROXY} --chain=${CHAIN_ID} \
