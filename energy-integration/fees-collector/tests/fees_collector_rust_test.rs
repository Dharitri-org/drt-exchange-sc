...
use dharitri_wasm::types::{BigInt, DctTokenPayment, ManagedVec};
...
fn claim_first_week_test() {
    ...
    fc_setup
        .b_mock
        .check_dct_balance(&first_user, FIRST_TOKEN_ID, &rust_zero);
    fc_setup
        .b_mock
        .check_dct_balance(&second_user, FIRST_TOKEN_ID, &rust_zero);
...
fn claim_after_dex_inactive_test() {
    ...
    fc_setup.b_mock.check_dct_balance(
        &first_user,
        FIRST_TOKEN_ID,
...
fn claim_second_week_test() {
    ...
    fc_setup
        ...
        .execute_query(&fc_setup.fc_wrapper, |sc| {
            ...
            expected_total_rewards.push(DctTokenPayment::new(
...
fn try_claim_after_unlock() {
    ...
    fc_setup
        .b_mock
        .check_dct_balance(&first_user, SECOND_TOKEN_ID, &rust_zero);
